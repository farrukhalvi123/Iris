...
class view_homepage:
    ...
    def pagination_click_50(self):
        self.driver.find_element(By.XPATH, self.drop_down_selector ).click()
        self.driver.find_element(By.XPATH, self.expand_more_50).click()

    def pagination_click_100(self):
        self.driver.find_element(By.XPATH, self.drop_down_selector).click()
        self.driver.find_element(By.XPATH, self.expand_more_100).click()
